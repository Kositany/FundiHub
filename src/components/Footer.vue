      ...
      <div class="grid md:grid-cols-4 gap-8 mb-12">
        ...
        <div class="md:col-span-2">
          <div class="flex items-center space-x-2 mb-6">
            ...
            <span class="text-2xl font-bold">FundiHub</span>
          </div>
          <p class="text-gray-300 leading-relaxed max-w-md">
            Connecting you with trusted professionals for all your home and business needs. 
          ...
          <div class="flex items-center space-x-6 text-sm text-gray-400">
            ...
            <div class="flex items-center space-x-2">
              ...
              <div class="flex space-x-2">
                <span class="bg-gray-800 px-2 py-1 rounded text-xs">Web</span>
                <span class="bg-gray-800 px-2 py-1 rounded text-xs">iOS</span>
                <span class="bg-gray-800 px-2 py-1 rounded text-xs">Android</span>
              </div>
            </div>
          </div>
        </div>
